...
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Outfit:wght@700;800;900&family=JetBrains+Mono:wght@300;400;500;600&display=swap');
...
.block-container { padding: 1.2rem 2rem 5rem !important; max-width: 1480px !important; }
...
.stApp::before {
  ...
  background:
    radial-gradient(ellipse 70% 45% at 15% 15%, rgba(0,255,178,.05) 0%, transparent 65%),
    radial-gradient(ellipse 55% 40% at 85% 80%, rgba(61,155,255,.05) 0%, transparent 65%),
    radial-gradient(ellipse 45% 35% at 55% 5%,  rgba(157,127,255,.04) 0%, transparent 65%),
    radial-gradient(ellipse 30% 25% at 90% 20%, rgba(0,229,255,.03)   0%, transparent 65%),
    linear-gradient(rgba(0,255,178,.015) 1px, transparent 1px),
    linear-gradient(90deg, rgba(0,255,178,.015) 1px, transparent 1px);
  background-size: 100% 100%, 100% 100%, 100% 100%, 100% 100%, 52px 52px, 52px 52px;
...
[data-testid="stSidebar"] {
  background: linear-gradient(180deg, #040810 0%, #020408 100%) !important;
  border-right: 1px solid var(--border2) !important;
  box-shadow: 6px 0 50px rgba(0,0,0,.7), inset -1px 0 0 rgba(0,255,178,.05) !important;
}
[data-testid="stSidebar"] .block-container { padding: 1rem 1.2rem 2rem !important; }
[data-testid="stSidebar"]::after {
  content: '';
  position: absolute; top: 0; right: 0; width: 1px; height: 100%;
  background: linear-gradient(180deg, transparent 0%, var(--green) 25%, var(--blue) 75%, transparent 100%);
  opacity: .18; animation: sidebarGlow 5s ease-in-out infinite alternate;
}
@keyframes sidebarGlow { 0%{opacity:.08} 100%{opacity:.28} }
...
.stTextArea textarea:focus, .stTextInput input:focus {
  ...
  box-shadow: 0 0 0 3px rgba(0,255,178,.07), 0 0 20px rgba(0,255,178,.05) !important;
...
[data-testid="stFileUploader"]:hover {
  border-color: var(--green) !important;
  background: rgba(0,255,178,.02) !important;
  box-shadow: 0 0 22px rgba(0,255,178,.06) !important;
  transform: translateY(-1px) !important;
}

/* ─── BUTTONS ────────────────────────────────────── */
.stButton > button {
  background: linear-gradient(135deg, #00FFB2 0%, #00C896 100%) !important;
  ...
  box-shadow: 0 0 24px rgba(0,255,178,.3), 0 4px 18px rgba(0,0,0,.45) !important;
  transition: all .22s cubic-bezier(.4,0,.2,1) !important;
  position: relative !important; overflow: hidden !important;
  animation: btnGlow 3s ease-in-out infinite !important;
}
@keyframes btnGlow {
  0%,100%{ box-shadow: 0 0 24px rgba(0,255,178,.3), 0 4px 18px rgba(0,0,0,.45); }
  50%    { box-shadow: 0 0 44px rgba(0,255,178,.55), 0 4px 18px rgba(0,0,0,.45); }
}
...
.stButton > button:hover { transform: translateY(-3px) !important; animation: none !important;
  box-shadow: 0 0 52px rgba(0,255,178,.6), 0 10px 28px rgba(0,0,0,.55) !important; }
...
.stDownloadButton > button {
  ...
  border: 1px solid rgba(0,255,178,.28) !important;
  border-radius: 10px !important;
  font-family: 'JetBrains Mono', monospace !important;
...
.stDownloadButton > button:hover {
  ...
  border-color: var(--green) !important;
  box-shadow: 0 0 18px rgba(0,255,178,.14) !important;
...
.stTabs [data-baseweb="tab-list"] {
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,.025), 0 4px 18px rgba(0,0,0,.28) !important;
}
.stTabs [data-baseweb="tab"] {
  ...
  text-transform: uppercase !important;
  padding: 9px 17px !important; border: none !important;
  transition: all .18s ease !important;
}
...
.stTabs [aria-selected="true"] {
  ...
  color: #020810 !important; font-weight: 600 !important;
  box-shadow: 0 0 18px rgba(0,255,178,.28), 0 2px 8px rgba(0,0,0,.35) !important;
}
...
.stProgress > div > div > div > div {
  ...
  box-shadow: 0 0 10px rgba(0,255,178,.38) !important;
...
hr { border-color: var(--border2) !important; margin: 24px 0 !important; opacity: .35 !important; }
...
.card::before {
  ...
  background: linear-gradient(90deg, transparent, rgba(0,255,178,.2), transparent);
}
.card:hover {
  border-color: rgba(0,255,178,.18);
  box-shadow: 0 8px 36px rgba(0,0,0,.38), 0 0 0 1px rgba(0,255,178,.04);
...
.sec {
  ...
  border-bottom: 1px solid var(--border); padding-bottom: 8px; margin: 26px 0 16px;
...
.sec::before {
  ...
  box-shadow: 0 0 8px rgba(0,255,178,.38);
}
.lbl {
  font-family: 'JetBrains Mono', monospace; font-size: 10px;
  text-transform: uppercase; letter-spacing: 1.5px; color: var(--muted); margin-bottom: 4px;
}
...
.chip {
  ...
  font-family: 'JetBrains Mono', monospace; font-size: 10px;
  margin: 2px; letter-spacing: .4px; border: 1px solid;
  transition: all .18s ease; cursor: default;
}
.chip:hover { transform: translateY(-1px); filter: brightness(1.18); }
.chip-g { background:rgba(0,255,178,.07);   color:var(--green);  border-color:rgba(0,255,178,.28);   }
.chip-r { background:rgba(255,61,107,.07);  color:var(--red);    border-color:rgba(255,61,107,.28);  }
.chip-a { background:rgba(255,184,48,.07);  color:var(--amber);  border-color:rgba(255,184,48,.28);  }
.chip-b { background:rgba(61,155,255,.07);  color:var(--blue);   border-color:rgba(61,155,255,.28);  }
.chip-v { background:rgba(157,127,255,.07); color:var(--violet); border-color:rgba(157,127,255,.28); }
.chip-c { background:rgba(0,229,255,.07);   color:var(--cyan);   border-color:rgba(0,229,255,.28);   }

/* ─── ALERTS ─────────────────────────────────────── */
.al {
  border-radius: 10px; padding: 11px 15px; margin-bottom: 9px;
...
.al-g { background:rgba(0,255,178,.05);  border-color:var(--green);  color:#7FFFD4; }
.al-a { background:rgba(255,184,48,.05); border-color:var(--amber);  color:#FFD68A; }
.al-r { background:rgba(255,61,107,.05); border-color:var(--red);    color:#FFB3C1; }
.al-b { background:rgba(61,155,255,.05); border-color:var(--blue);   color:#A8D4FF; }
...
.fade-in-2 { animation: fadeInUp .45s ease .1s both; }
.fade-in-3 { animation: fadeInUp .45s ease .2s both; }
...
def render_header(company="", analyzed_at=""):
    ...
    ts = (f'<span style="font-family:JetBrains Mono,monospace;font-size:10px;color:var(--muted);'
          f'margin-left:12px;vertical-align:middle;">🕐 {analyzed_at}</span>') if analyzed_at else ""
    st.markdown(f"""
...
def render_empty():
    ...
    st.markdown("""
      <div style="display:flex;gap:8px;flex-wrap:wrap;justify-content:center;max-width:560px;margin:0 auto;">
        ...
        <span class="tag">Section Scores</span>
        <span class="tag">Recruiter Sim</span>
        <span class="tag">Interview Prep</span>
        <span class="tag">Cover Letter</span>
        <span class="tag">Bullet Fixer</span>
      </div>
      <div style="margin-top:24px;display:flex;gap:16px;flex-wrap:wrap;justify-content:center;">
        <div style="font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--muted);
          ...
          📄 Upload PDF → Paste JD → Click Analyze
        </div>
        <div style="font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--muted);
                    background:rgba(255,255,255,.03);border:1px solid var(--border);
                    border-radius:8px;padding:7px 14px;">
          ⚡ No API key? Demo mode auto-activates
        </div>
        <div style="font-family:'JetBrains Mono',monospace;font-size:11px;color:#FF3D6B;
                    background:rgba(255,61,107,.04);border:1px solid rgba(255,61,107,.25);
                    border-radius:8px;padding:7px 14px;">
          💀 Try Brutal Mode for unfiltered feedback
        </div>
      </div>
    </div>
    """, unsafe_allow_html=True)
